...
public class PatchouliProvider extends PatchouliBookProvider {
	...
	protected void addBooks(Consumer<BookBuilder> consumer, HolderLookup.Provider provider) {
		BookBuilder bookBuilder = createBookBuilder("chocopedia",
				...
				.setCustomBookItem(new ItemStackTemplate(ModRegistry.CHOCOPEDIA.get()))
		...
		bookBuilder = bookBuilder.addCategory("chocobos", "info.chococraft.book.chocobos.name",
				...
				.addSpotlightPage(new ItemStackTemplate(ModRegistry.GYSAHL_GREEN_ITEM.get()))
				.setText("info.chococraft.book.chocobo.text4").build()
				.addImagePage(Chococraft.modLoc("textures/gui/entry/chocobo.png"))
				...
				.addSmeltingPage(Chococraft.modLoc("chocobo_drumstick_cooked")).build()
				.addSmokingPage(Chococraft.modLoc("chocobo_drumstick_cooked_from_smoking")).build()
				.addCampfirePage(Chococraft.modLoc("chocobo_drumstick_cooked_from_campfire_cooking")).build()
				.build()
				...
				.addSpotlightPage(new ItemStackTemplate(ModRegistry.CHOCOBO_FEATHER.get())).build()
				.build()
		...
		bookBuilder = bookBuilder.addCategory("gysahls", "info.chococraft.book.gysahls.name",
				...
				.addSpotlightPage(new ItemStackTemplate(ModRegistry.LOVERLY_GYSAHL_GREEN.get())).build()
				.build()
				...
				.addSpotlightPage(new ItemStackTemplate(ModRegistry.GOLD_GYSAHL.get())).build()
				.build()
				...
				.addCraftingPage(Chococraft.modLoc("red_gysahl")).build()
				.build()
				...
				.addCraftingPage(Chococraft.modLoc("pink_gysahl")).build()
				.build()
				...
				.addImagePage(Chococraft.modLoc("textures/gui/entry/gysahl.png"))
				.setText("info.chococraft.book.gysahl_green.text2").setBorder(true).build()
				.addCraftingPage(Chococraft.modLoc("gysahl_green_to_seeds"))
				.setText("info.chococraft.book.gysahl_green.text3").build()
				.addTextPage("info.chococraft.book.gysahl_green.text4").build()
				.addSpotlightPage(new ItemStackTemplate(ModRegistry.GYSAHL_GREEN_ITEM.get())).build()
				.build()
				...
				.addCraftingPage(Chococraft.modLoc("pickled_gysahl_raw")).build()
				.addSmeltingPage(Chococraft.modLoc("pickled_gysahl_cooked")).build()
				.addSmokingPage(Chococraft.modLoc("pickled_gysahl_cooked_from_smoking")).build()
				.addCampfirePage(Chococraft.modLoc("pickled_gysahl_cooked_from_campfire_cooking")).build()
				.build()
				...
				.addCraftingPage(Chococraft.modLoc("gysahl_cake")).build()
				.build()
		...
		bookBuilder = bookBuilder.addCategory("equipments", "info.chococraft.book.equipments.name",
				...
				.addImagePage(Chococraft.modLoc("textures/gui/entry/chocodisguise.png")).setBorder(true).build()
				.addCraftingPage(Chococraft.modLoc("choco_disguise_helmet"))
				.setRecipe2(Chococraft.modLoc("choco_disguise_chestplate")).build()
				.addCraftingPage(Chococraft.modLoc("choco_disguise_leggings"))
				.setRecipe2(Chococraft.modLoc("choco_disguise_boots")).build()
				.build()
				...
				.addCraftingPage(Chococraft.modLoc("chocobo_saddle"))
				.setRecipe2(Chococraft.modLoc("chocobo_saddle_alt")).build()
				.addTextPage("info.chococraft.book.saddle.text2").build()
				.addCraftingPage(Chococraft.modLoc("chocobo_saddle_bags"))
				.setRecipe2(Chococraft.modLoc("chocobo_saddle_pack")).build()
				.build()
				...
				.addCraftingPage(Chococraft.modLoc("chocobo_whistle")).build()
				.build()
		...
		bookBuilder = bookBuilder.addCategory("misc", "info.chococraft.book.misc.name",
				...
				.addCraftingPage(Chococraft.modLoc("straw")).build()
				.build()
