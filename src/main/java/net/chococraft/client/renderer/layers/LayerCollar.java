...
public class LayerCollar extends LayerRenderer<ChocoboEntity, EntityModel<ChocoboEntity>> {
	...
	public LayerCollar(IEntityRenderer<ChocoboEntity, EntityModel<ChocoboEntity>> rendererIn) {
		super(rendererIn);
	}
