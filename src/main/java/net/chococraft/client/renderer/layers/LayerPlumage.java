...
public class LayerPlumage extends LayerRenderer<ChocoboEntity, EntityModel<ChocoboEntity>> {

	private ResourceLocation PLUMAGE = new ResourceLocation(Chococraft.MODID, "textures/entities/chocobos/plumage.png");

	public LayerPlumage(IEntityRenderer<ChocoboEntity, EntityModel<ChocoboEntity>> rendererIn) {
		super(rendererIn);
	}
