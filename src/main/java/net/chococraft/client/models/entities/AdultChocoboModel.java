...
public class AdultChocoboModel<T extends Chocobo> extends EntityModel<Chocobo> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create()
				...
				PartPose.offsetAndRotation(0.0F, -8.0F, -10.0F, -0.20943951023931953F, 0.0F, 0.0F));
		...
		partdefinition.addOrReplaceChild("child_body", CubeListBuilder.create()
						.texOffs(0, 6).addBox(-2F, -2.5F, -2F, 4, 4, 4),
				PartPose.offset(0.0F, 20F, 0.0F));

		partdefinition.addOrReplaceChild("child_head", CubeListBuilder.create()
						.texOffs(0, 0).addBox(-1.5F, -3F, -1.5F, 3, 3, 3),
				PartPose.offset(0.0F, 18F, -2.5F));

		partdefinition.addOrReplaceChild("child_left_leg", CubeListBuilder.create()
						.texOffs(12, 0).addBox(-0.5F, 0.0F, -1F, 1, 2, 1),
				PartPose.offset(1.0F, 22F, 0.5F));

		partdefinition.addOrReplaceChild("child_right_leg", CubeListBuilder.create()
