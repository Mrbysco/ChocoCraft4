...
public class ChocoboInventoryScreen extends ContainerScreen<SaddleBagMenu> {
	...
	public ChocoboInventoryScreen(SaddleBagMenu container, PlayerInventory playerInventory, ChocoboEntity chocobo) {
	...
	public static void openInventory(int windowId, ChocoboEntity chocobo) {
		...
		SaddleBagMenu saddleContainer = new SaddleBagMenu(windowId, player.inventory, chocobo);
	...
	protected void renderLabels(MatrixStack matrixStack, int x, int y) {
		...
		this.font.draw(matrixStack, this.inventory.getDisplayName(), 8, this.imageHeight - 96 + 2, 0x888888);
	}
}
